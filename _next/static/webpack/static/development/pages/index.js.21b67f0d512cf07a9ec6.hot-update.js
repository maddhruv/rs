  ...
  _createClass(Home, [{
    ...
    value: function handleWhatsApp() {
      ...
      for (var i = 0; i < this.state.bill.length; i++) {
        bill += "Item ".concat(i + 1, ": ").concat(this.state.bill[i]);
      }
...
//# sourceMappingURL=index.js.21b67f0d512cf07a9ec6.hot-update.js.map