  ...
  _createClass(Home, [{
    ...
    value: function handleWhatsApp() {
      ...
      for (var i = 0; i < this.state.bill.length; i++) {
        bill += "Item ".concat(i++, ": ").concat(this.state.bill[i]);
      }
...
//# sourceMappingURL=index.js.dd67ea17d549ebc09880.hot-update.js.map